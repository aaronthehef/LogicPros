...
export const BackendContactForm = () => {
  ...
  return (
    <div className="contact-form-container">
      ...
      <p className="form-subtitle">
        Tell us about your business and project goals. Email sent directly to aaron@logicpros.ca
      </p>
      ...
      <form onSubmit={handleSubmit} className="contact-form">
        ...
        <p className="form-note">
          * Required fields. Email sent directly to aaron@logicpros.ca. We typically respond within 2-4 hours during business hours.
        </p>
      </form>
    </div>
  );
