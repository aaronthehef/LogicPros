        ...
        <section className="section" style={{ backgroundColor: '#fff3cd', padding: '60px 0' }}>
          <div className="container">
            <div className="section-header" style={{ marginBottom: '50px' }}>
              ...
              <p style={{ fontSize: '1.2rem', color: '#5d6d7e', maxWidth: '800px', margin: '20px auto 0' }}>
            ...
            <div className="features-grid animate-on-scroll" style={{ marginBottom: '50px' }}>
              <div className="feature-item" style={{ textAlign: 'center', padding: '30px' }}>
                ...
                <p style={{ fontSize: '0.95rem', color: '#7f8c8d', marginTop: '10px' }}>According to Microsoft Security Intelligence</p>
              </div>
              <div className="feature-item" style={{ textAlign: 'center', padding: '30px' }}>
                ...
                <p style={{ fontSize: '0.95rem', color: '#7f8c8d', marginTop: '10px' }}>Verizon Data Breach Investigations Report</p>
              </div>
              <div className="feature-item" style={{ textAlign: 'center', padding: '30px' }}>
                ...
                <p style={{ fontSize: '0.95rem', color: '#7f8c8d', marginTop: '10px' }}>Canadian Centre for Cyber Security</p>
              </div>
            </div>
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.9)', borderRadius: '15px', padding: '40px', marginTop: '40px' }}>
              ...
              <div className="features-grid">
                <div style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ color: '#5d6d7e' }}>Cost of a data breach in Canada (IBM, 2024)</p>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2rem', marginBottom: '15px' }}>⏰</div>
                  <h4 style={{ color: '#2c3e50', marginBottom: '10px' }}>287 Days Average</h4>
                  <p style={{ color: '#5d6d7e' }}>Time to identify and contain a breach</p>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2rem', marginBottom: '15px' }}>📉</div>
                  <h4 style={{ color: '#2c3e50', marginBottom: '10px' }}>60% Close</h4>
                  <p style={{ color: '#5d6d7e' }}>Small businesses close within 6 months of major breach</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div style={{ marginBottom: '60px' }}>
              ...
              <div className="features-grid animate-on-scroll">
                <div style={{ textAlign: 'center', padding: '30px', background: '#f8f9fa', borderRadius: '15px' }}>
                  ...
                  <p style={{ color: '#5d6d7e' }}>Passwords, PINs, security questions, or passphrases that exist in your memory</p>
                </div>
                <div style={{ textAlign: 'center', padding: '30px', background: '#f8f9fa', borderRadius: '15px' }}>
                  <div style={{ fontSize: '3rem', marginBottom: '20px' }}>📱</div>
                  <h4 style={{ color: '#2c3e50', marginBottom: '15px' }}>Something You Have</h4>
                  <p style={{ color: '#5d6d7e' }}>Mobile devices, hardware tokens, smart cards, or authenticator apps</p>
                </div>
                <div style={{ textAlign: 'center', padding: '30px', background: '#f8f9fa', borderRadius: '15px' }}>
                  <div style={{ fontSize: '3rem', marginBottom: '20px' }}>👤</div>
                  <h4 style={{ color: '#2c3e50', marginBottom: '15px' }}>Something You Are</h4>
                  <p style={{ color: '#5d6d7e' }}>Fingerprints, facial recognition, voice patterns, or retinal scans</p>
                </div>
              </div>
            </div>
            ...
            <div className="services-grid animate-on-scroll">
              <div className="service-card" style={{ border: '2px solid #3498db' }}>
                ...
                <div style={{ marginTop: '20px' }}>
                  ...
                  <ul style={{ color: '#5d6d7e', marginTop: '10px', paddingLeft: '20px' }}>
          ...
          <div className="container">
            ...
            <div className="services-grid animate-on-scroll" style={{ marginBottom: '60px' }}>
              <div className="service-card" style={{ padding: '40px', border: '3px solid #3498db', borderRadius: '15px' }}>
                ...
                <p style={{ color: '#5d6d7e', lineHeight: '1.6', marginBottom: '25px' }}>
                ...
                <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '10px' }}>
                  ...
                  <ul style={{ color: '#5d6d7e', paddingLeft: '20px', margin: '0' }}>
                ...
                <div style={{ marginTop: '20px', padding: '15px', background: '#e8f4f8', borderRadius: '8px' }}>
                  <strong style={{ color: '#2c3e50' }}>Timeline:</strong> <span style={{ color: '#5d6d7e' }}>1-2 weeks</span>
                </div>
              </div>
              ...
              <div className="service-card" style={{ padding: '40px', border: '3px solid #e74c3c', borderRadius: '15px' }}>
                ...
                <div style={{ marginTop: '20px', padding: '15px', background: '#fdf2f2', borderRadius: '8px' }}>
                  <strong style={{ color: '#2c3e50' }}>Timeline:</strong> <span style={{ color: '#5d6d7e' }}>2-4 weeks</span>
                </div>
              </div>
              ...
              <div className="service-card" style={{ padding: '40px', border: '3px solid #27ae60', borderRadius: '15px' }}>
                ...
                <div style={{ marginTop: '20px', padding: '15px', background: '#f0f9f4', borderRadius: '8px' }}>
                  <strong style={{ color: '#2c3e50' }}>Timeline:</strong> <span style={{ color: '#5d6d7e' }}>Ongoing</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ background: 'white', borderRadius: '20px', padding: '50px', boxShadow: '0 20px 40px rgba(0,0,0,0.1)' }}>
              ...
              <div className="features-grid">
                <div style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ color: '#5d6d7e', fontSize: '0.95rem' }}>Available throughout New Brunswick for initial setup and training</p>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2.5rem', marginBottom: '15px' }}>💻</div>
                  <h4 style={{ color: '#2c3e50', marginBottom: '15px', fontSize: '1.2rem' }}>Remote Support</h4>
                  <p style={{ color: '#5d6d7e', fontSize: '0.95rem' }}>24/7 remote monitoring and support for all implemented systems</p>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '2.5rem', marginBottom: '15px' }}>📞</div>
                  <h4 style={{ color: '#2c3e50', marginBottom: '15px', fontSize: '1.2rem' }}>Local Expertise</h4>
                  <p style={{ color: '#5d6d7e', fontSize: '0.95rem' }}>Maritime timezone support with understanding of local business needs</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="section" style={{ backgroundColor: '#2c3e50', color: 'white', padding: '80px 0' }}>
          <div className="container">
            <div className="section-header" style={{ marginBottom: '60px' }}>
              ...
              <p style={{ fontSize: '1.2rem', color: '#bdc3c7', maxWidth: '800px', margin: '20px auto 0' }}>
