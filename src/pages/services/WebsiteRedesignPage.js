            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '4rem', alignItems: 'center' }}>
              <div style={{ textAlign: 'left', color: 'white' }}>
                ...
                <p style={{
                  ...
                  Modernize your online presence with a fresh design that reflects your current brand and meets today's user expectations.
                </p>
                  ...
                  <div style={{ position: 'relative', zIndex: 1 }}>
                    <div style={{
                      ...
                      {focus.icon === 'navigation' && (
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <polygon points="3,11 22,2 22,22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                          <line x1="12" y1="17" x2="12" y2="22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                          <line x1="7" y1="12" x2="7" y2="22" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      )}
        ...
        <section style={{
          ...
          <div className="container">
            <h2 style={{
              ...
              fontWeight: '700',
              marginBottom: '30px'
            }}>Ready to refresh your website?</h2>
            <p style={{
              fontSize: '1.3rem',
              marginBottom: '40px',
              maxWidth: '600px',
              ...
              Let's discuss how a redesign can improve your online presence and help you achieve your business goals.
            </p>
            <div style={{
              display: 'flex',
