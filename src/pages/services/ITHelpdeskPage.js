...
export const ITHelpdeskPage = () => {
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional IT support and helpdesk services in New Brunswick. Fast response times, expert technicians, and reliable solutions for your business technology needs.');
    }
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '4rem', alignItems: 'center' }}>
              <div style={{ textAlign: 'left', color: 'white' }}>
                ...
                <p style={{
                  ...
                  Professional IT support when you need it. Fast response times, expert technicians, and reliable solutions to keep your business running smoothly.
                </p>
          ...
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <p style={{
                ...
                Keeping your business technology running smoothly
              </p>
            </div>
          ...
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <p style={{
                ...
                Comprehensive IT support for all your technology needs
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Diagnosing and resolving problems with computers, servers, printers, and other physical devices, including repairs and replacement recommendations.'
                },
                {
                  icon: 'software',
                  title: 'Software Support',
                  description: 'Installing, configuring, and troubleshooting business applications, operating systems, and specialized software your team relies on.'
                },
                {
                  icon: 'accounts',
                  title: 'User Account Management',
                  description: 'Creating and managing user accounts, permissions, and access controls across your systems to ensure proper security.'
                },
                {
                  icon: 'email',
                  title: 'Email & Communication',
                  description: 'Setting up and maintaining email systems, video conferencing tools, and other communication platforms your business uses.'
                },
                {
                  icon: 'printer',
                  title: 'Printer & Peripheral Support',
                  description: 'Connecting and troubleshooting printers, scanners, and other peripheral devices to ensure they work properly with your systems.'
                },
                {
                  icon: 'remote',
                  title: 'Remote & On-Site Support',
                  description: 'Providing flexible support options including remote assistance for quick fixes and on-site visits for hands-on solutions.'
                }
              ].map((service, index) => (
                <div key={index} style={{
          ...
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <p style={{
                ...
                A structured approach to resolving your IT issues efficiently
              </p>
            </div>
            ...
            <div style={{ marginTop: '40px', paddingTop: '20px', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '30px' }}>
              <div style={{ position: 'relative', padding: '60px 40px 40px 40px', marginTop: '35px', overflow: 'visible', background: 'white', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)' }}>
                ...
                <p style={{ color: colors.text.secondary, lineHeight: '1.6' }}>Submit your IT issue through our helpdesk system, phone, or email. Our support team acknowledges and categorizes your request within 2 hours during business hours.</p>
              </div>
              ...
              <div style={{ position: 'relative', padding: '60px 40px 40px 40px', marginTop: '35px', overflow: 'visible', background: 'white', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)' }}>
                ...
                <h3 style={{ color: colors.text.primary, marginBottom: '15px', marginTop: '20px' }}>Diagnosis & Triage</h3>
                <p style={{ color: colors.text.secondary, lineHeight: '1.6' }}>Our technicians assess the issue, determine urgency, and identify the most efficient solution path, either through remote access or scheduling on-site assistance.</p>
              </div>
              ...
              <div style={{ position: 'relative', padding: '60px 40px 40px 40px', marginTop: '35px', overflow: 'visible', background: 'white', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)' }}>
                ...
                <p style={{ color: colors.text.secondary, lineHeight: '1.6' }}>We implement the solution, keeping you informed of progress and estimated completion times. Most common issues are resolved within the same business day.</p>
              </div>
              ...
              <div style={{ position: 'relative', padding: '60px 40px 40px 40px', marginTop: '35px', overflow: 'visible', background: 'white', borderRadius: '16px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)' }}>
                ...
                <p style={{ color: colors.text.secondary, lineHeight: '1.6' }}>After resolution, we verify everything is working properly and document the solution for future reference, helping us spot patterns that might indicate larger issues.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <p style={{
                ...
                Business types that benefit most from professional IT support
              </p>
            </div>
            ...
            <div style={{
              ...
              {[
                {
                  title: 'Small Businesses Without IT Staff',
                  description: 'Organizations that rely on technology but do not have dedicated IT personnel, leaving employees to handle technical issues outside their expertise.'
                },
                {
                  title: 'Growing Companies Outgrowing DIY IT',
                  description: 'Businesses where informal tech support from a knowledgeable employee is no longer sufficient as systems become more complex and critical to operations.'
                },
                {
                  title: 'Organizations With Aging Infrastructure',
                  description: 'Companies using older systems that require more frequent maintenance and expertise to keep running reliably until upgrades are planned.'
                },
                {
                  title: 'Businesses Experiencing Frequent IT Issues',
                  description: 'Organizations that face ongoing technology problems distracting from core business activities and need expert help to achieve stability.'
                }
              ].map((benefit, index) => (
                <div key={index} style={{
                  background: 'white',
        ...
        <section style={{
          ...
          <div className="container">
            <h2 style={{
              ...
              fontWeight: '700',
              marginBottom: '30px'
            }}>Ready for reliable IT support?</h2>
            <p style={{
              fontSize: '1.3rem',
              marginBottom: '40px',
              maxWidth: '600px',
              ...
              Let's discuss how our helpdesk services can keep your technology running smoothly and minimize disruptions to your business.
            </p>
            <div style={{
              display: 'flex',
