        ...
        <section className="section" style={{ backgroundColor: '#f8f9fa' }}>
          <div className="container">
            ...
            <div className="services-grid" style={{ marginTop: '50px' }}>
              <div className="service-card" style={{ position: 'relative', padding: '40px', marginTop: '25px' }}>
                <div style={{ position: 'absolute', top: '-25px', left: '30px', background: '#3498db', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(52, 152, 219, 0.3)' }}>1</div>
              ...
              <div className="service-card" style={{ position: 'relative', padding: '40px', marginTop: '25px' }}>
                <div style={{ position: 'absolute', top: '-25px', left: '30px', background: '#e74c3c', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(231, 76, 60, 0.3)' }}>2</div>
              ...
              <div className="service-card" style={{ position: 'relative', padding: '40px', marginTop: '25px' }}>
                <div style={{ position: 'absolute', top: '-25px', left: '30px', background: '#27ae60', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(39, 174, 96, 0.3)' }}>3</div>
              ...
              <div className="service-card" style={{ position: 'relative', padding: '40px', marginTop: '25px' }}>
                <div style={{ position: 'absolute', top: '-25px', left: '30px', background: '#8e44ad', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(142, 68, 173, 0.3)' }}>4</div>
