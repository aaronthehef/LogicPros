      ...
      <main className="main-content">
        ...
        <section className="section" style={{ backgroundColor: '#f8f9fa' }}>
          <div className="container">
            ...
            <div className="services-grid" style={{ marginTop: '60px', paddingTop: '20px' }}>
              <div className="service-card" style={{ position: 'relative', padding: '50px 40px 40px 40px', marginTop: '30px' }}>
                <div style={{ position: 'absolute', top: '-15px', left: '30px', background: '#3498db', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(52, 152, 219, 0.3)', zIndex: 10 }}>1</div>
              ...
              <div className="service-card" style={{ position: 'relative', padding: '50px 40px 40px 40px', marginTop: '30px' }}>
                <div style={{ position: 'absolute', top: '-15px', left: '30px', background: '#e74c3c', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(231, 76, 60, 0.3)', zIndex: 10 }}>2</div>
              ...
              <div className="service-card" style={{ position: 'relative', padding: '50px 40px 40px 40px', marginTop: '30px' }}>
                <div style={{ position: 'absolute', top: '-15px', left: '30px', background: '#27ae60', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(39, 174, 96, 0.3)', zIndex: 10 }}>3</div>
              ...
              <div className="service-card" style={{ position: 'relative', padding: '50px 40px 40px 40px', marginTop: '30px' }}>
                <div style={{ position: 'absolute', top: '-15px', left: '30px', background: '#8e44ad', color: 'white', width: '50px', height: '50px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 'bold', boxShadow: '0 4px 12px rgba(142, 68, 173, 0.3)', zIndex: 10 }}>4</div>
