  ...
  return (
    <div className="landing-page">
      ...
      <main className="main-content">
        ...
        <section className="section">
          <div className="container">
            <h2>Real Results for Painting Contractors</h2>
            <div className="results-grid">
              <div className="result-item">
                <h3>Precision Paint Professionals</h3>
                <p><strong>Challenge:</strong> Losing high-end residential jobs to competitors with better online presence and portfolio display.</p>
                <p><strong>Solution:</strong> Premium website showcasing luxury home transformations, color expertise, and high-end client testimonials.</p>
                <p><strong>Results:</strong> 190% increase in residential painting inquiries, average project value increased to $8,500.</p>
              </div>
              <div className="result-item">
                <h3>Commercial Coating Specialists</h3>
                <p><strong>Challenge:</strong> Commercial clients couldn't find them online and were hiring larger painting companies for office projects.</p>
                <p><strong>Solution:</strong> Commercial-focused website highlighting business expertise, minimal disruption processes, and corporate references.</p>
                <p><strong>Results:</strong> Won 3 major commercial contracts worth $180K, established ongoing maintenance relationships.</p>
              </div>
              <div className="result-item">
                <h3>Heritage House Painters</h3>
                <p><strong>Challenge:</strong> Seasonal revenue drops during winter months with reduced exterior painting demand.</p>
                <p><strong>Solution:</strong> Year-round marketing strategy promoting interior painting, holiday preparation, and winter project planning.</p>
                <p><strong>Results:</strong> Maintained 75% revenue during off-season, booked $95K in interior projects during winter months.</p>
              </div>
            </div>
          </div>
        </section>
