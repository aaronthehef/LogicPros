...
export const SaintJohnAutomationsPage = () => {
  const heroRef = useRef(null);
  const headerRef = useRef(null);

  useEffect(() => {
    document.title = 'AI Automation Saint John | Workflow Automation & AI Chatbots NB | LogicPros';

    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'AI automation services for Saint John businesses. Workflow automation, AI chatbots, email marketing automation, social media scheduling, and data integrations built by a local New Brunswick team.');
    }

    const structuredData = {
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "name": "LogicPros - AI Automation Saint John",
      "description": "AI automation and workflow automation services for Saint John, NB businesses.",
      "url": "https://logicpros.ca/locations/saint-john/automations",
  ...
  return (
    <div className="landing-page homepage">
      ...
      <main className="main-content">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '4rem', alignItems: 'center' }}>
              <div style={{ textAlign: 'left', color: 'white' }}>
                ...
                <p style={{ fontSize: 'clamp(1rem, 1.8vw, 1.2rem)', color: 'rgba(255,255,255,0.8)', lineHeight: '1.7', marginBottom: '2.5rem', maxWidth: '520px', fontWeight: '300' }}>
                  Saint John businesses are spending too much time on work that software can handle. We build AI chatbots, email sequences, social media workflows, and data integrations — set up once, running without you.
                </p>
                <p style={{ fontSize: '0.85rem', color: 'rgba(255,255,255,0.45)', marginBottom: '2.5rem', maxWidth: '520px', lineHeight: '1.6' }}>
                  Serving Saint John, Quispamsis, Rothesay, Grand Bay-Westfield, and surrounding Greater Saint John communities.
                </p>
        ...
        <section style={{ background: 'linear-gradient(135deg, #16213e 0%, #0f3460 100%)', padding: '80px 0' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: '700', color: 'white', marginBottom: '20px' }}>What We Automate for Saint John Businesses</h2>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '1.1rem', maxWidth: '700px', margin: '0 auto', lineHeight: '1.6' }}>
                From solo operators to growing Saint John businesses — if it's repetitive, manual, or error-prone, it's a candidate for automation.
              </p>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px', maxWidth: '1100px', margin: '0 auto' }}>
              {[
                ...
                },
                {
                  ...
                  desc: 'Weeks of posts planned and published automatically. Build your local Saint John audience without spending an hour a day on social.',
          ...
          <div className="container">
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '8px' }}>
                Workflow Automation for Saint John Businesses
              </h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '3rem', alignItems: 'start', marginBottom: '2rem' }}>
                <div>
                  ...
                  <p style={{ color: '#4a5568', fontSize: '1rem', lineHeight: '1.8', marginBottom: '1.5rem' }}>
                    Research consistently shows that managers and business owners spend 8 or more hours per week on routine data tasks that automation can handle. For a small Saint John operation, that is a full workday recovered every single week.
                  </p>
                </div>
                <img
                  src="/images/automations/workflow.jpg"
                  alt="Workflow automation for Saint John businesses"
        ...
        <section id="ai-chatbots" style={{ padding: '80px 0', background: '#f8fafc' }}>
          <div className="container">
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '8px' }}>
                AI Chatbots for Saint John Businesses
              </h2>
              <div style={{ width: '50px', height: '4px', background: 'linear-gradient(135deg, #1d7aaf, #1e40af)', borderRadius: '2px', marginBottom: '2rem', marginTop: '8px' }}></div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '3rem', alignItems: 'start', marginBottom: '2rem' }}>
                <div>
                  ...
                  <p style={{ color: '#4a5568', fontSize: '1rem', lineHeight: '1.8', marginBottom: '1.5rem' }}>
                    Studies show that 64% of consumers rate 24/7 availability as the top benefit of chatbots, and 55% of businesses using chatbots for marketing report an increase in high-quality leads. For a Saint John business with no after-hours staff, a chatbot is effectively a front-desk employee who never goes home.
                  </p>
                </div>
                <img
                  src="/images/automations/chatbot.jpg"
                  alt="AI chatbot for Saint John businesses"
                  style={{ width: '100%', borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', objectFit: 'cover', height: '280px' }}
                />
              </div>
              ...
              <div style={{ background: 'linear-gradient(135deg, rgba(29,122,175,0.06), rgba(30,64,175,0.04))', border: '1px solid rgba(29,122,175,0.15)', borderLeft: '4px solid #1d7aaf', borderRadius: '0 12px 12px 0', padding: '24px 28px', marginBottom: '2rem', marginTop: '2rem' }}>
                <div style={{ fontSize: '0.75rem', fontWeight: '700', color: '#1d7aaf', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '12px' }}>In Practice</div>
                <p style={{ color: '#4a5568', fontSize: '1rem', lineHeight: '1.8', margin: 0 }}>
                  A Saint John contractor's chatbot answers questions about project timelines and service areas at 10pm, then asks for the visitor's name and phone number and flags the conversation for follow-up the next morning. A dental clinic's chatbot handles booking inquiries and insurance questions instantly, reducing phone volume. A local retail store uses a chatbot to handle "do you carry X?" questions, check availability, and link directly to the product page. In each case, the business captures interest that would otherwise leave without converting.
                </p>
              </div>
        ...
        <section id="email-automation" style={{ padding: '80px 0', background: 'white' }}>
          <div className="container">
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '8px' }}>
                Email Marketing Automation for Saint John Businesses
              </h2>
              <div style={{ width: '50px', height: '4px', background: 'linear-gradient(135deg, #1d7aaf, #1e40af)', borderRadius: '2px', marginBottom: '2rem', marginTop: '8px' }}></div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '3rem', alignItems: 'start', marginBottom: '2rem' }}>
                <div>
                ...
                <img
                  ...
                  alt="Email marketing automation for Saint John businesses"
                  style={{ width: '100%', borderRadius: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.1)', objectFit: 'cover', height: '280px' }}
                />
              </div>
        ...
        <section id="social-media" style={{ padding: '80px 0', background: '#f8fafc' }}>
          <div className="container">
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '8px' }}>
                Social Media Scheduling for Saint John Businesses
              </h2>
              <div style={{ width: '50px', height: '4px', background: 'linear-gradient(135deg, #1d7aaf, #1e40af)', borderRadius: '2px', marginBottom: '2rem', marginTop: '8px' }}></div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '3rem', alignItems: 'start', marginBottom: '2rem' }}>
                <div>
        ...
        <section id="data-integration" style={{ padding: '80px 0', background: 'white' }}>
          <div className="container">
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '8px' }}>
                Data Integration for Saint John Businesses
              </h2>
              <div style={{ width: '50px', height: '4px', background: 'linear-gradient(135deg, #1d7aaf, #1e40af)', borderRadius: '2px', marginBottom: '2rem', marginTop: '8px' }}></div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '3rem', alignItems: 'start', marginBottom: '2rem' }}>
                <div>
        ...
        <section id="document-automation" style={{ padding: '80px 0', background: '#f8fafc' }}>
          <div className="container">
            <div style={{ maxWidth: '860px', margin: '0 auto' }}>
              ...
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '8px' }}>
                Document Automation for Saint John Businesses
              </h2>
              <div style={{ width: '50px', height: '4px', background: 'linear-gradient(135deg, #1d7aaf, #1e40af)', borderRadius: '2px', marginBottom: '2rem', marginTop: '8px' }}></div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '3rem', alignItems: 'start', marginBottom: '2rem' }}>
                <div>
              ...
              <div style={{ background: 'linear-gradient(135deg, rgba(29,122,175,0.06), rgba(30,64,175,0.04))', border: '1px solid rgba(29,122,175,0.15)', borderLeft: '4px solid #1d7aaf', borderRadius: '0 12px 12px 0', padding: '24px 28px', marginBottom: '2rem', marginTop: '2rem' }}>
                <div style={{ fontSize: '0.75rem', fontWeight: '700', color: '#1d7aaf', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '12px' }}>In Practice</div>
                <p style={{ color: '#4a5568', fontSize: '1rem', lineHeight: '1.8', margin: 0 }}>
                  A Saint John renovation contractor fills out a short intake form with the client name, job address, scope, and price. The automation generates a fully formatted proposal PDF, attaches it to an email, and sends it to the client within seconds. When the client accepts, the same data populates a contract, which is sent for e-signature automatically. Once signed, the system creates the first invoice with the deposit amount and sends it directly to the client. An accounting firm automates their monthly client reports — the data is pulled from the client's books, the report is generated in a standard format, and it is emailed to the client on the first of every month without anyone touching it.
                </p>
              </div>
        ...
        {/* Why LogicPros in Saint John */}
        <section className="section">
          <div className="container">
            <div className="section-header">
              <h2 className="section-title">Why Saint John Businesses Choose LogicPros for Automation</h2>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px', maxWidth: '1000px', margin: '0 auto' }}>
              {[
                { title: 'New Brunswick-based, not offshore', desc: 'Based in Fredericton, serving Saint John and southern NB. You call a local number and get a real person who knows your market.' },
        ...
        <section style={{ padding: '80px 0', background: '#f8fafc' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '50px' }}>
              <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', fontWeight: '700', color: '#1a1a2e', marginBottom: '16px' }}>Industries We Serve in Greater Saint John</h2>
              <p style={{ color: '#64748b', fontSize: '1.05rem', maxWidth: '640px', margin: '0 auto' }}>Serving businesses in Saint John, Quispamsis, Rothesay, and Grand Bay-Westfield across every sector.</p>
            </div>
        ...
        <section style={{ padding: '80px 0', background: 'white' }}>
          <div className="container">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              ...
              <p style={{ color: '#64748b', fontSize: '1.05rem', maxWidth: '580px', margin: '0 auto' }}>Common questions from Saint John business owners about automation.</p>
            </div>
        ...
        <section style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #0f3460 100%)', padding: '80px 0', textAlign: 'center' }}>
          <div className="container">
            <h2 style={{ fontSize: 'clamp(1.8rem, 3vw, 2.8rem)', fontWeight: '700', color: 'white', marginBottom: '20px' }}>
              Ready to Automate Your Saint John Business?
            </h2>
            ...
            <p style={{ color: 'rgba(255,255,255,0.5)', marginTop: '20px', fontSize: '0.9rem' }}>
              (506) 478-2949 · contact@logicpros.ca · Serving Saint John, NB
            </p>
          </div>
        </section>
